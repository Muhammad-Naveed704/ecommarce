...
const addresses = [
  ...
  {
    name: 'Rashid Khan',
    street: 'Musharaf Colony Howksbay',
    city: 'karachi',
    pinCode: 7200,
    state: 'sindh',
    Phone: +923021234456
            ...
            <form className="bg-white px-5 mt-12">
              <div className="space-y-12">
                <div className="border-b border-gray-900/10 pb-12">
                  <h2 className="text-4xl font-bold tracking-tight my-5 text-gray-900" >
                ...
                <div className="border-b border-gray-900/10 pb-12">
                        ...
                        <div className="hidden shrink-0 sm:flex sm:flex-col sm:items-end">
                          ...
                          {address.state ? (
                            <p className="mt-1 text-xs leading-5 text-gray-500">
                              Phone Number <time dateTime={address.city}>{address.Phone}</time>
                            </p>
                          ) : (
                  ...
                  <div className="mt-10 space-y-10">
                    ...
                    <fieldset>
                      ...
                      <p className="mt-1 text-sm leading-6 text-gray-600">Chose One</p>
